...
int main(){
	int  nGS1Prefix, nGroupIdentifier, nPublisherCode, nItemNumber, nCheckDigit;

	printf("Enter ISBN: ");
	scanf("%d-%d-%d-%d-%d", &nGS1Prefix, &nGroupIdentifier, &nPublisherCode, &nItemNumber, &nCheckDigit);
	printf("GS1 prefix: %d\n", nGS1Prefix);
